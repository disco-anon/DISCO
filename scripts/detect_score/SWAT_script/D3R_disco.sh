...
# Source: 脚本_d3r.sh command 18 (self_impl.D3R_disco)
nohup "$PYTHON_BIN" -u ./scripts/run_benchmark.py \
    ...
    --gpus 6 --num-workers 1 --timeout 60000 --aggregate_type max \
    --save-path "score/D3R_disco" > log/score_swat_d3r_disco.log 2>&1 &

# Source: 脚本_d3r_disco.sh command 8 (self_impl.D3R_disco)
