...
# Source: 脚本_d3r.sh command 17 (self_impl.D3R_disco)
nohup "$PYTHON_BIN" -u ./scripts/run_benchmark.py \
    ...
    --save-path "score/D3R_disco" > log/score_psm_d3r_disco.log 2>&1 &

# Source: 脚本_d3r_disco.sh command 7 (self_impl.D3R_disco)
...
# Source: 脚本_d3r_disco_rerun_fix.sh command 1 (self_impl.D3R_disco)
nohup /root/miniconda3/envs/tsrl/bin/python -u ./scripts/run_benchmark.py \
    --config-path "unfixed_detect_score_multi_config.json" \
    --data-name-list "PSM.csv" \
    --model-name "self_impl.D3R_disco" \
    ...
    --gpus 1 --num-workers 1 --timeout 60000 --aggregate_type max \
    --save-path "score/D3R_disco" > log/score_psm_d3r_disco_fix.log 2>&1 &
