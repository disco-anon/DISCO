...
# Source: 脚本_d3r.sh command 16 (self_impl.D3R_disco)
nohup "$PYTHON_BIN" -u ./scripts/run_benchmark.py \
    ...
    --save-path "score/D3R_disco" > log/score_msl_d3r_disco.log 2>&1 &

# Source: 脚本_d3r_disco.sh command 6 (self_impl.D3R_disco)
