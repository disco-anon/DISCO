...
# Source: 脚本_d3r.sh command 12 (self_impl.D3R_disco)
nohup "$PYTHON_BIN" -u ./scripts/run_benchmark.py \
    ...
    --save-path "label/D3R_disco" > log/label_psm_d3r_disco.log 2>&1 &

# Source: 脚本_d3r_disco.sh command 2 (self_impl.D3R_disco)
