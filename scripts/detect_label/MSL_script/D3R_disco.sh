...
# Source: 脚本_d3r.sh command 11 (self_impl.D3R_disco)
nohup "$PYTHON_BIN" -u ./scripts/run_benchmark.py \
    ...
    --gpus 0 --num-workers 1 --timeout 60000 --aggregate_type max \
    --save-path "label/D3R_disco" > log/label_msl_d3r_disco.log 2>&1 &

# Source: 脚本_d3r_disco.sh command 1 (self_impl.D3R_disco)
